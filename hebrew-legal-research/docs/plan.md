# Hebrew Legal Research Skill — Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build a skill that teaches Claude to assist with Israeli legal research — searching legislation, case law, and legal concepts in Hebrew law, and preparing legal document summaries.

**Architecture:** Domain-Specific Intelligence skill. Embeds knowledge of Israeli legal system structure, court hierarchy, key legislation databases, and Hebrew legal terminology. No MCP dependency — operates as standalone domain knowledge.

**Tech Stack:** SKILL.md, references for legal database guides and terminology.

---

## Research

### Israeli Legal System Structure
- **Knesset (Parliament):** Primary legislation (Chukei HaKnesset)
- **Courts hierarchy:**
  - Supreme Court (Beit HaMishpat HaElyon) — also sits as High Court of Justice (Bagatz)
  - District Courts (Beit Mishpat Mechozi) — 6 districts
  - Magistrate Courts (Beit Mishpat Shalom)
  - Labor Courts (Beit Din LaAvoda)
  - Religious Courts (Batei Din Rabaniim, Sharia, Druze, Christian)
  - Military Courts
- **Secondary legislation:** Takanot (regulations), Tzavim (orders)

### Legal Databases
- **Nevo:** Primary commercial database — legislation, case law, legal articles (paid)
  - URL: `https://www.nevo.co.il`
  - No public API, requires subscription
- **Takdin:** Second major database — recently adding AI search
  - URL: `https://www.takdin.co.il`
  - No public API
- **Kol Zchut (All Rights):** Free public legal information wiki
  - URL: `https://www.kolzchut.org.il`
  - RAGbot prototype exists
  - Content available under CC license
- **Knesset website:** Free access to legislation text
  - URL: `https://main.knesset.gov.il/Activity/Legislation/`
  - Some structured data available
- **Court rulings portal:** Selected rulings published online
  - URL: `https://www.court.gov.il`

### Key Israeli Laws Commonly Referenced
- Basic Laws (Chukei Yesod) — quasi-constitutional
- Companies Law (Chok HaChevarot) 1999
- Contracts Law (General Part) (Chok HaChozim) 1973
- Employment Laws: Annual Leave, Sick Pay, Severance, Hours of Work
- Privacy Protection Law 1981
- Consumer Protection Law 1981
- Real Estate (Land) Law 1969
- Planning and Building Law 1965

### Use Cases
1. **Explain legal concepts** — Translate Hebrew legal terms, explain court procedures
2. **Identify relevant legislation** — Find which laws apply to a given scenario
3. **Summarize legal requirements** — Employment law, contract law, real estate law
4. **Draft legal document outlines** — Contract structure, legal notice templates
5. **Court procedure guidance** — Which court, filing requirements, deadlines
...
**Files:**
- Create: `repos/security-compliance/hebrew-legal-research/SKILL.md`
...
- `references/court-hierarchy.md` — Full Israeli court system diagram
- `references/key-legislation.md` — Top 50 most-referenced Israeli laws with section guides
- `references/legal-databases-guide.md` — How to access Nevo, Takdin, Kol Zchut, Knesset portal
