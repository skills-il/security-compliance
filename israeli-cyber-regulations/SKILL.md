...
- **National Cybersecurity Bill (draft, January 2026).** A draft National Cyber Defense Law (tazkir) was published and reported in late January 2026, imposing binding controls on "essential organizations" (irgun chiyoni) and codifying CERT-IL / INCD authority, with ISO 27001/27002 offered as a compliance route. Not yet enacted, but track for applicability scoping. Flag clients with critical-infrastructure exposure to expect future statutory expansion of the current INCD methodology.
