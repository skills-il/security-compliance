...
הוראה 357 מכסה אבטחה לשירותי תשלום ולפעילות פינטק.
...
- הוראת בנק ישראל 357 מחייבת חברות פינטק להגיש הערכת סייבר לפני השקה. סוכנים עלולים לא לסמן את הדרישה הטרום-השקתית הזו כשהם מייעצים לסטארטאפי תשלומים ישראליים.
...
פתרון: החילו את כל המסגרות הרלוונטיות. התחילו מבסיס מערך הסייבר (חל על כולם), ואז הוסיפו שכבות של דרישות מגזריות. לגופים בפיקוח כפול (למשל, פינטק שנסחר בבורסה), שלבו הוראה 357 + דרישות רשות ני"ע.
