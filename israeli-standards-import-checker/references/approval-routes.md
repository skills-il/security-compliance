# Approval Routes for Imports Subject to Israeli Official Standards
...
|---|---|---|
| Green | 50% of commercial shipments per year | Product classified green in the importer's product file |
| Gold | 33% of commercial shipments per year | Twelve consecutive months on Green first |
| Diamond | Sell before test completes | Only for importers with green-classified files; detailed conditions in SII guidelines |

Contact: gali_aviv@sii.org.il for eligibility questions.

## 4. Declaration-based entry (July 2024)

- Effective date: 1 July 2024.
- Mechanism: importer declares compliance using a test report from an ILAC-accredited foreign laboratory.
...
- A manual in Hebrew for consumer products is required.
- Failure to meet a mandatory standard must be reported immediately to the Commissioner of Standardization.
- The shipment release is contingent on evidence in the importer's product file.
