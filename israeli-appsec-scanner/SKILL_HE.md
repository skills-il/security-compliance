...
לפי החוק הישראלי, מאגרים מסוימים עם מידע אישי חייבים להירשם ברשות:
...
3. **חידוש שנתי**: הרישום חייב להתחדש כל שנה
4. **פטורים**: מאגרים שמשמשים רק לניהול יחסי עובד-מעביד (בתנאים מסוימים)
...
החוק הישראלי מגביל העברת מידע אישי מחוץ לישראל. ההעברה מותרת כש:

- מדינת היעד מספקת רמת הגנה נאותה (מדינות האיחוד האירופי, שמוכרות על ידי הרשות)
- נושא המידע הסכים להעברה
- ההעברה דרושה לקיום חוזה
- יש ערובות חוזיות מתאימות (סעיפים חוזיים סטנדרטיים)
...
- לחוק הגנת הפרטיות הישראלי (1981) כללי דיווח על אירוע אבטחה שונים מ-GDPR. אין דדליין של 72 שעות; החוק אומר "ללא דיחוי". סוכנים עלולים להחיל בטעות לוחות זמנים של GDPR על אירועים ישראליים.
